...
<main>
  ...
  <div class="mx-auto w-11/12 lg:w-11/12 xl:w-10/12">
    ...
    <p class="text-xl text-white border-2 border-[#ffcb0a] bg-[#ffcb0a]/20 mt-4 p-3 rounded inline-block">
      (734)223-7792
    </p>
    <p class="text-xl text-white border-2 border-[#00ff00] bg-[#00ff00]/20 mt-4 p-3 rounded inline-block">
      admin@finalbossxr.com
    </p>
  </div>
</main>
<style>
